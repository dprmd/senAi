export const modelDescription = {
  ...
  llama_3_1_70b_versatile:
    "Llama 3.1 70b is a versatile model suitable for a wide range of applications, including chatbots, question answering, and more.",
  llama_3_1_8b_instant:
    "Llama 3.1 8b is a high-speed, instant-response model designed for efficient and rapid applications.",
};
